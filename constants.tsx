...
// Multi-method notification status messages
export const NOTIFICATION_STATUS_MESSAGES: Record<Language, Record<Exclude<NotificationStatus, 'idle'>, string>> = {
  english: {
    sending: '📱 Sending notification...',
    success: '✅ Caregiver notified successfully',
    error: '❌ Failed to notify caregiver.',
  },
  hindi: {
    sending: '📱 सूचना भेजी जा रही है...',
    success: '✅ देखभाल करने वाले को सफलतापूर्वक सूचित किया गया',
    error: '❌ देखभाल करने वाले को सूचित करने में विफल।',
  },
  tamil: {
    sending: '📱 அறிவிப்பு அனுப்பப்படுகிறது...',
    success: '✅ பராமரிப்பாளருக்கு வெற்றிகரமாக அறிவிக்கப்பட்டது',
    error: '❌ பராமரிப்பாளருக்கு அறிவிக்கத் தவறிவிட்டது.',
  },
  telugu: {
    sending: '📱 నోటిఫికేషన్ పంపుతోంది...',
    success: '✅ సంరక్షకుడికి విజయవంతంగా తెలియజేయబడింది',
    error: '❌ సంరక్షకుడికి తెలియజేయడంలో విఫలమైంది.',
  },
};

// Legacy support - keeping for backward compatibility
export const TELEGRAM_STATUS_MESSAGES = NOTIFICATION_STATUS_MESSAGES;
